...
HD_PWD='C:/Users/8183666/Desktop/lab-1/tmp/lab-1/lab-1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sw_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sw_test.tcl -notrace
