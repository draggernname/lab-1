...
HD_PWD='C:/Users/8183666/Desktop/lab-1/tmp/lab-1/lab-1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sw_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sw_test.tcl
